...
- Run once for a full rewrite, then use the brand copy edit pass for ongoing refinement. Optional neighbors: Smell Check / Misemphasis on the rewritten copy; CraftAssay for a quality score of the page as presented. Not required.
