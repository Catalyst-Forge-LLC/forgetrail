...
- [ ] [AppLedger spec pack](specs/app-ledger-spec-pack-v0.1.0/README.md): format checker started in sibling repo [appledger](https://github.com/Catalyst-Forge-LLC/appledger) (npm name staked at `0.0.0`). ForgeTrail adoption (tracking cutover, xFacts maintenance) is still open.
