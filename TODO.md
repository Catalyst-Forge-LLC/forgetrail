...
- [ ] [Companion tools](specs/companion-tools.md): weave Catalyst Forge siblings into ForgeTrail as situation-triggered suggestions (FilePress, LocalHelm/LocalSlip, practice skills, and others). Draft for review; implementation starts after the tier table is approved.
